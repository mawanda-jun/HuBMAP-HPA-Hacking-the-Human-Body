...
def get_windows(img_height, img_width, crop_height, crop_width, stride_height, stride_width):
    """
    ...
    crops_per_row = 1 + int((img_height + height_pad - stride_height) / stride_height)
    crops_per_col = 1 + int((img_width + width_pad - stride_width) / stride_width)
...
if "__main__" in __name__:
    print(get_windows(511, 511, 510, 510, 510, 510))
    print(len(get_windows(1024, 1024, 512, 512, 256, 256)))
    print(len(get_windows(1024, 1024, 512, 512, 512, 512)))
    print(len(get_windows(1024, 1024, 128, 128, 768, 768)))
