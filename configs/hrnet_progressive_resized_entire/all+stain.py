...
albu_color_transforms = [
    ...
    dict(type="RandomResizedCrop", height=crop_size[0], width=crop_size[1], scale=(0.8, 1.2), p=1.),
    dict(
...
# data_root = '/home/mawanda/Documents/HuBMAP/for_mmdetection_resized1024_multires_512_inverted'
data_root = '/home/mawanda/Documents/HuBMAP/for_mmdetection_resized1024_6000_inverted'
